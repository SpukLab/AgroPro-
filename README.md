...
4. Revisar `docs/TECHNICAL-STACK-v0.1.md` y `docs/PERSISTENCE-MODEL-v0.1.md`.
5. Continuar Milestone A desde `app/`.
6. Aprovisionar un proyecto Supabase exclusivo de SURKARA antes de convertir el draft SQL en migración real.
