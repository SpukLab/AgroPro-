# AGROPRO — Domain Blueprint v0.2

**Estado:** CANDIDATE  
**Fecha:** 2026-09-24  
**Propósito:** definir los límites de dominio de AGROPRO antes de rediseñar arquitectura, persistencia o interfaz.

## 1. Visión

AGROPRO es una **plataforma operacional agropecuaria de punta a punta**.
...
AGROPRO no intenta convertir todas estas actividades en un único modelo genérico. La plataforma comparte infraestructura operacional; cada dominio conserva sus propias entidades, reglas, estados y lenguaje.
...
Los documentos externos mantienen su autoridad externa. AGROPRO conserva representación, estado, vínculo y evidencia.
...
La composición es explícita y versionable por jornada.
...
AGROPRO nunca debe confundir **CPE preparada** con **CPE autorizada**.
...
## 18. Protocolo operacional compartido
...
## 19. Plan → Execution → Evidence → Result

Patrón principal de AGROPRO.
...
## 21. Flujos obligatorios para validar el dominio
...
DAHZEA será un cliente externo autorizado de AGROPRO.
...
### Command
Enviar una solicitud estructurada a AGROPRO.
...
## 24. Decisiones adoptadas

**DB-001** AGROPRO será una plataforma multi-dominio, no una aplicación monolítica de cosecha.  
...
**DB-014** AGROPRO modelará explícitamente Field Deployment & Support: cuadrillas desplazadas, base móvil/casilla, suministros, rotaciones y costos de soporte.  
...
## 25. Hipótesis principal

AGROPRO debe poder responder:
...
Si la plataforma responde estas preguntas de manera confiable, offline, trazable y entre dominios, existe una base suficientemente sólida para expandir AGROPRO.
